...
exports.createAction = function (type, handler, metadataFactory) {
    var actionCreator = (metadataFactory
        ? function (payload) { return ({ type: type, payload: payload, meta: metadataFactory(payload) }); }
